...
export function AdminSidebar({ userName, pendingCount = 0 }: Props) {
  ...
  return (
    <aside className="w-56 min-h-screen bg-slate-800 flex flex-col flex-shrink-0">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-slate-700">
        <span className="text-white font-bold text-xl tracking-tight">KintaiApp</span>
        <p className="text-slate-400 text-xs mt-0.5">管理画面</p>
      </div>
